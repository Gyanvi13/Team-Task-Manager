  ...
  return (
    <div className="space-y-6">
      <section className="rounded-[2rem] border border-white/10 bg-gradient-to-br from-sky-500/20 via-cyan-500/10 to-transparent p-6">
        <p className="text-sm uppercase tracking-[0.3em] text-sky-300">Admin control center</p>
        <h3 className="mt-3 text-3xl font-semibold text-white">Manage projects, tasks, and team activity.</h3>
        <p className="mt-2 max-w-2xl text-slate-300">See overall progress, task distribution, and team size from one command center.</p>
      </section>
      {overview && (
